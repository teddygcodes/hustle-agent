"""Session 121: sample fresh v2 matcher holdout pairs for Codex labeling.

Runs the deterministic matcher over the full S116 queue, stamps each row with
the current v2 matcher classification, and samples 40 previously unlabeled
pairs across MATCH_HIGH_CONFIDENCE, MATCH_NEEDS_REVIEW, and NO_MATCH.
"""
...
DEFAULT_OUTPUT_PATH = ROOT / "bot" / "state" / "codex_sampling_matcher_holdout_s121.jsonl"
DEFAULT_SEED = 121
