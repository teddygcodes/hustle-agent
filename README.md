...
## Recent Improvements (Apr 20–May 8)

Sixteen arcs covering Apr 20 → May 8, then a session-by-session recap. **Full detail for each session lives in [CLAUDE.md](CLAUDE.md)**; the entries below link directly to the canonical session ☑ blocks.
