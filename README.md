...
│   ├── weekly_digest.py     # 8-section aggregator (P&L, cohort, calibration, excursion, journal, universe, CF coverage, bot health) over existing tools. _safe_section() failure-tolerance per section; runs in <1s; archives output to bot/state/weekly_digest_YYYY-MM-DD.md (Apr 28 Session 24)
