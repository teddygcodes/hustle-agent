...
- **Honest P&L position (end of dual-day arc):** Realized P&L sits at **+$18.78 across 210 settled trades** on the $10,500 paper base — but **+$172.52 of that is the SFPHI singleton.** Strip SFPHI: bot is **−$153.74 net (−1.46%)**. Per-strategy: vig_stack +$55 (62% WR, mean +$0.41/trade — outlier-dependent, would be −$187 without SFPHI + KXINX-81); live_momentum **−$36 (31% WR, mean −$0.49/trade)** with asymmetric-loss multiplier 0.54 (losses 1.85× wins). The bot is preserving capital, not yet growing it. The dual-day arc was 80% foundation work (observability, discipline, search-frontier expansion, lab) + 20% direct intervention (Session 49 sizing). The bet is that the foundation enables faster, smarter strategy iteration over the next 2-3 weeks. **Bot isn't profitable — we're collecting information to get there.** The May 13-18 cluster of re-validations (Session 38a ATP, Session 49 NBA/UFC sizing, Session 22 MOMENTUM_LEADER_MIN) is the first sharp decision point — and any concurrent_fire_candidate the agent surfaces over the next 14 days that the lab validates becomes a NEW shippable strategy.
- **Test baseline: 1,359 passed / 0 failed** (was 1,309 baseline at Session 43b ship; +12 from Session 47, +15 from Session 48, +8 from Session 49, +4 from Session 50, +11 from Session 51).
...
17. [Recent Improvements (Apr 20–May 2)](#recent-improvements-apr-20may-2)
...
## Recent Improvements (Apr 20–May 2)
