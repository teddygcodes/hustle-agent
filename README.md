...
- **Honest P&L position (May 1 evening):** Realized P&L sits at **+$18.78 across 210 settled trades** on the $10,500 paper base — but **+$172.52 of that is the SFPHI singleton.** Strip SFPHI: bot is **−$153.74 net (−1.46%)**. Per-strategy: vig_stack +$55 (62% WR, mean +$0.41/trade — outlier-dependent, would be −$187 without SFPHI + KXINX-81); live_momentum **−$36 (31% WR, mean −$0.49/trade)** with asymmetric-loss multiplier 0.54 (losses 1.85× wins). The bot is preserving capital, not yet growing it. Today was 90% foundation work (observability, discipline, search-frontier expansion) + 10% direct intervention (Session 49 sizing). The bet is that the foundation enables faster, smarter strategy iteration over the next 2-3 weeks. **Bot isn't profitable — we're collecting information to get there.** The May 13-18 cluster of re-validations (Session 38a ATP, Session 49 NBA/UFC sizing, Session 22 MOMENTUM_LEADER_MIN) is the first sharp decision point.
- **Test baseline: 1,344 passed / 0 failed** (was 1,309 baseline at Session 43b ship; +12 from Session 47 cross-cohort refinement, +15 from Session 48 concurrent_attack_angles, +8 from Session 49 sizing tests).
- **Calendar of scheduled routines:** see `REPORT_CALENDAR.md` at the repo root. Daily 3 AM ET (daily report), daily 6 AM ET (discovery agent — 9 heuristics), weekly Sundays 6 AM ET (weekly report). One-offs through May 18: **May 6** Session 36 day-7 hold-to-settlement check; **May 7** Session 39 day-7 flaky-Kalshi stress check; **May 12** weekly digest spot-check; **May 13** dual routine (Session 36 day-14 floor signal recheck + Session 38a ATP re-validation); **May 15** Session 49 per-sport sizing re-validation; **May 18** MOMENTUM_LEADER_MIN re-validation. Each routine writes its report file to disk before any interpretation work — partial chat death preserves data.
